...
public class RealworldSteps extends BaseSteps {
  ...
  @Step
  public static void modifiesPost(DataTable dataTable) throws IOException {
  ...
  public static void addComment(DataTable dataTable) throws IOException {
    sendRequestWithBodyJson(POST, _API_ARTICLES_+sessionVariableCalled("slug")+"/comments/",createBody(dataTable));
  }
  @Step
